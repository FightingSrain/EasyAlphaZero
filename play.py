...
class Gobang(game.Game):
    ...
    #         print("-------")
    #
    #     if int(i) != int(self.AI_i) and int(j) != int(self.AI_j):
    #         self.board[self.AI_i][self.AI_j] = WHITE
    #         print("*****")
    ...
    #     # for i in range(ROWS):
    #     #     for j in range(ROWS):
    #     #         if int(self.record[i][j]) == 1:
    #     #             self.draw_chess(BLACK, i, j)
    #     #         elif int(self.record[i][j]) == -1:
    #     #             self.draw_chess(WHITE, i, j)
    #     # pygame.display.flip()
    #
    #
